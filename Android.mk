...
include $(CLEAR_VARS)
LOCAL_MODULE := QonsistentSaberColors
...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -DID='"QonsistentSaberColors"' -DVERSION='"1.1.1"' -I'./shared' -I'./extern' -isystem'extern/codegen/include' -frtti
